...
export default function ProjectDetail({ project, onBack }) {
  ...
  const hasMotionMedia = Boolean(project.detailVideo || project.detailGif);
  ...
  return (
    ...
    >
      ...
      <div className="prx-detail-main">
        ...
        {/* Project Image */}
        <div className={`prx-detail-image ${hasMotionMedia ? 'prx-detail-gif-frame' : ''}`}>
          {project.detailVideo ? (
            <video
              src={project.detailVideo}
              poster={project.image}
              aria-label={`${project.title} workflow animation`}
            ...
            <img
              src={detailMedia}
              alt={`${project.title} ${project.detailGif ? 'workflow animation' : 'preview'}`}
              className="w-full h-full"
            />
          )}
          {!hasMotionMedia && <div className="prx-detail-image-overlay" />}
        </div>
