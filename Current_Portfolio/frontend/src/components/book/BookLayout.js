...
export default function BookLayout({
  ...
  return (
    ...
    >
      ...
      <ScrollCue visible={!isFlipping && !isLastPage && currentPage !== 2} />

      {/* Close book button */}
      <button
        onClick={onCloseBook}
        className="absolute top-2 right-2 md:top-4 md:right-4 z-30 w-11 h-11 flex items-center justify-center
                   text-[#4A4F6A] hover:text-navy bg-page/75 backdrop-blur-sm transition-colors duration-200"
