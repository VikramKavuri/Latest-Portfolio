      ...
      <ScrollReveal delay={0.05}>
        <div className="flex flex-wrap items-center gap-4 md:gap-6 mb-2">
          <a
            ...
            className="flex min-h-11 items-center gap-2 text-[#1a1a2e] hover:text-navy transition-colors duration-200 font-body text-xs md:text-sm"
          >
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="flex h-11 w-11 items-center justify-center text-[#4A4F6A] hover:text-navy transition-colors duration-200"
            >
              <Github size={16} />
            </a>
            <a
          ...
          {sent ? (
            <div className="h-full flex flex-col items-center justify-center text-center">
              ...
              <button
                ...
                className="min-h-11 px-3 text-sm font-body text-gold underline underline-offset-4 hover:text-gold/80 transition-colors"
              >
            ...
            <form onSubmit={handleSubmit} className="h-full flex flex-col">
              ...
              <div className="flex-1 space-y-3 md:space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full min-h-11 bg-[#16162a] border border-[#2a2a4a] rounded-lg py-2.5 pl-10 pr-4
                                 font-body text-base text-white placeholder-[#8888aa]
                ...
                <div className="relative flex-1">
                  ...
                  <textarea
                    ...
                    className="w-full h-full min-h-[120px] bg-[#16162a] border border-[#2a2a4a] rounded-lg py-2.5 pl-10 pr-4
                               font-body text-base text-white placeholder-[#8888aa]
                               focus:outline-none focus:border-gold/50 focus:ring-1 focus:ring-gold/20
              ...
              <div className="mt-4">
                <button
                  type="submit"
                  disabled={sending}
                  className="group w-full min-h-12 flex items-center justify-center gap-2 px-6 py-3
