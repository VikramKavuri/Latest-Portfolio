          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-between px-6 sm:px-8 py-4 sm:py-5 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white flex-shrink-0">
                ...
                <button
                  onClick={handleClose}
                  className="w-11 h-11 p-2 rounded-xl hover:bg-gray-100 text-gray-400 hover:text-gray-700 transition-colors flex items-center justify-center"
                  aria-label="Close"
                >
                  <X size={22} />
                </button>
                  ...
                  {analysisResult && (
                    ...
                    >
                      ...
                      >
                        ...
                        <button
                          onClick={handleReset}
                          className="min-h-11 px-6 py-2.5 text-sm font-medium text-gray-600 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors"
                        >
